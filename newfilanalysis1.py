    ...
    if uploaded_file and filename and feedfactor:
        ...
        try:
            ...
            if json_data["X_mea"].size > 0:
                ...
                for Z_ref in Z_ref_distinct:
                    if Z_ref not in Z_mea_distinct:
                        continue

                    measured_data = np.vstack((json_data["X_mea"][json_data["Z_mea"] == Z_ref],
                                                json_data["Y_mea"][json_data["Z_mea"] == Z_ref])).T
